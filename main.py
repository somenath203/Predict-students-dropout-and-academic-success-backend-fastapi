...
async def predict(studentInfo: StudentInfoModel):
    ...
    if prediction[0] == 0:
        resultMsg = 'We are sorry to say but you have a high chance of getting dropout from academics in future.'
    elif prediction[0] == 1:
        resultMsg = 'We are glad to say that you have a high chance of success in your academics in future.'
    elif prediction[0] == 2:
        resultMsg = 'We are glad to tell you that you will be enrolled in an educational institution in future.'

    return {
        'success': True,
        'message': 'Your future academic performance has been predicted successfully',
        'data': str(prediction[0]),
        'resMessage': resultMsg
    }
